...
This directory contains the Python scripts used to generate the experimental stimulus videos.

Each script corresponds to one experimental condition and produces the video used in the experiment.
